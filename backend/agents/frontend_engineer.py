...
class FrontendEngineerAgent:
    ...
    def _generate_frontend_base(self, project_id: str) -> Dict[str, Any]:
        """Generate React + Vite base structure."""
        ...
        structure = {
            project_name: {
                "frontend": {
                    "src": {
                        "pages": {
                            "Login.jsx": self._login_page_template(),
                            "Register.jsx": self._register_page_template(),
                        },
                        "hooks": {
                            "useAuth.js": self._use_auth_hook_template(),
                        }
                    }
                }
            }
        ...
        structure = {
            project_name: {
                "frontend": {
                    "src": {
                        "components": {
                            f"{component_name}.jsx": f'''import React from 'react';

export default function {component_name}() {{
  return (
    <div className="{component_name.lower()}">
      <h2>{task_title}</h2>
      <p>Component generated by VibeCober</p>
    </div>
  );
}}
'''
